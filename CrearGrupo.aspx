<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearGrupo.aspx.cs" Inherits="RegistroNotas.CrearGrupo" %>
...
<body style="background-color:gray">
    ...
    <img src="https://png.pngtree.com/element_origin_min_pic/16/09/11/1257d4e4c9c7186.jpg" alt="" width="200" height="200" /></p>
        ...
        <p class="auto-style2">
            Crear grupo:</p>
        <p class="auto-style3">
            Ingrese los datos para crear el grupo:</p>
        ...
        <p>
            <asp:Button ID="ButtonCrearGrupo" runat="server" Text="Crear" Height="37px" Width="92px" />
        </p>
    </form>
</body>
</html>

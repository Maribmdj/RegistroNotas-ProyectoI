<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalizarPeriodo.aspx.cs" Inherits="RegistroNotas.FinalizarPeriodo" %>
...
<body style="background-color:gray">
    ...
    <img src="http://3.bp.blogspot.com/-GVhFx_DaIoM/UI7CQMKGOkI/AAAAAAAAB6o/OcYnNkdg7dU/s1600/Escuela.jpg" alt="" width="200" height="200" /></p>
        <p class="auto-style2">
            Finalizar Período</p>
        <p class="auto-style4">
            Ingrese el nombre del período que desea finalizar:</p>
        ...
        <p>
            <asp:Button ID="ButtonAnular" runat="server" Text="Finalizar" />
        </p>
    </form>
</body>
</html>

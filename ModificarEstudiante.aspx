<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarEstudiante.aspx.cs" Inherits="RegistroNotas.ModificarEstudiante" %>
...
<body style="background-color:gray">
    <form id="form1" runat="server">
        ...
        <p class="auto-style2">
            &nbsp;</p>
        <p class="auto-style2">
            Modificar Estudiante:</p>
        <p class="auto-style3">
            Ingrese el carné del estudiante y los datos que desea modificar:</p>
        <table class="auto-style4">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextNombre" runat="server" Width="248px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">Apellidos:</td>
                <td>
                    <asp:TextBox ID="TextApellidos" runat="server" Width="248px"></asp:TextBox>
                </td>
            </tr>
            <tr>
        ...
        <p>
            <asp:Button ID="ButtonModifcarEstudiante" runat="server" Height="37px" Text="Modificar" Width="103px" />
        </p>
    </form>
</body>
</html>
